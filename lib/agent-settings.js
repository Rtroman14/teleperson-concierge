...
export const getVapiSalesAssistantConfig = (systemMessage) => ({
    ...
    model: {
        ...
        messages: [
            {
                role: "system",
                //                 content: `Ask for the user's business email address. After they give it to you, call the contextualize_conversation tool. See details below:
                ...
                // When the user providers their email address, it'll come in via speech-to-text. So "ryan@webagent.ai" might read "ryan at web agent dot a I". Or "jesse@teleperson.com" might read something like "jesse at tele person dot com". Make your best judgement.
                //                 `,
                content: systemMessage,
            },
        ],
