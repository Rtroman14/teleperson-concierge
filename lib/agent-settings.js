...
If ${firstName} asks about the vendors in their vendor hub, say the name of the vendor. 
...
- **User Address**: Avoid using the user's name in every message.
        ...
        messages: [
            {
                ...
                content: getSystemMessage({
                    ...
                    guidelines: [
                        ...
                        "- **Formatting**: Use plain text formatting only. Do not include markdown syntax (such as asterisks, underscores, bullet points, or code blocks); instead, organize information with simple line breaks and clear sections.",
                    ],
                    previousConversations,
                }),
            },
