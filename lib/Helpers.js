...
class Helpers {
    ...
    getPromptName = (industry) => {
        const prompts = [
            {
                industry: "trucking",
                textPrompt: "trucking-chatbot-text",
                voicePrompt: "trucking-chatbot-voice",
                telemetryId: "trucking-chatbot",
            },
            {
                industry: "pharmacy",
                textPrompt: "pharmacy-chatbot-text",
                voicePrompt: "pharmacy-chatbot-voice",
                telemetryId: "pharmacy-chatbot",
            },
        ];

        const prompt = prompts.find((p) => p.industry === industry);

        if (prompt) return prompt;

        return {
            industry: "default",
            textPrompt: "sales-chatbot-text",
            voicePrompt: "sales-chatbot-voice",
        };
    };
}
